...
const Hero = () => {
  ...
  const { displayText: taglineText } = useTypewriter("MERN Stack & React Native Developer", 60, 4000);
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="mb-8">
            ...
            <p className="text-base text-foreground/80 mb-8 max-w-3xl mx-auto animate-fade-in-up" style={{ animationDelay: '5s', opacity: 0, animationFillMode: 'forwards' }}>
              I'm a passionate full-stack developer specializing in MERN Stack (MongoDB, Express, React, Node.js) and React Native.
              I create beautiful, performant web and mobile applications that deliver exceptional user experiences.
